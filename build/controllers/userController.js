        ...
        switch (_b.label) {
            case 0:
                ...
                if (!oldPassword || !newPassword || !newPasswordConfirm) {
                    return [2 /*return*/, next(new appError_1["default"]('Please provide correct inputs!', 400))];
                }
                if (newPassword !== newPasswordConfirm) {
                    return [2 /*return*/, next(new appError_1["default"]('Password Confirm is not the same!', 400))];
                }
                return [4 /*yield*/, store.updatePassword(id, oldPassword, newPassword)];
            case 1:
                user = _b.sent();
                if (!user) {
                    return [2 /*return*/, next(new appError_1["default"]('Your current password is wrong or user does not exist.', 401))];
                }
                res.status(200).json({
                    status: 'success',
                    data: {
