...
var addProduct = (0, catchAsync_1["default"])(function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var order, data;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, store.show(req.params.id)];
            case 1:
                order = _a.sent();
                if (!order) {
                    return [2 /*return*/, next(new appError_1["default"]('No order found with that ID', 404))];
                }
            ...
            case 2:
                ...
                res.status(200).json({
                    status: 'success',
                    data: data,
                    message: "Product ".concat(req.body.product_id, " added to order ").concat(req.params.id, " successfully")
                });
                return [2 /*return*/];
        }
    });
